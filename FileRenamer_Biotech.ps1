...
## Naming mode removed GÇö always use fields to build filenames
...
# Removed naming mode radio buttons GÇö always use fields
...
# Removed manual naming GÇö always use fields
